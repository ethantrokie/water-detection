...
def main():
    samples, y_labels = ct.LoopsThroughAllVids("/data/beehive/VideoWaterDatabase/videos/water/","/data/beehive/VideoWaterDatabase/masks/water/","/data/beehive/VideoWaterDatabase/videos/non_water/",500,2,0,4,200,5000,10,20)
